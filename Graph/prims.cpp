...
// Note: hame min heap wala priority queue chahiye so direct 
// by default initialize nahi kar sakte h (by default max heap P.Q. ban jaega 
// so) so greater etc likh ke min heap banao
